...
|---|---|---|---|---|---|
| `chat-smart` | gpt-oss-120b | 120B | 117.6 | 1.38 s | Réponses riches, synthèse, analyse |
...
| `mistral-small-24b` | Mistral-Small-3.2-24B-FP8 | 24B | 58.7 | 3.88 s | Modèle souverain, stable |
...
```
Tâche complexe, synthèse longue, raisonnement   →  chat-smart
...
Contrainte souveraineté / modèle national        →  mistral-small-24b
```
